...
namespace ResourceEstimation
{
    public class create_generator : Operation<Microsoft.Quantum.Chemistry.JordanWigner.JordanWignerEncodingData, (Microsoft.Quantum.Canon.GeneratorSystem,Int64)>, ICallable
    {
        ...
        String ICallable.FullName => "ResourceEstimation.create_generator";
...
#line 20 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
            var (nSpinOrbitals,data,statePrepData,energyShift) = qSharpData.Data;
#line 25 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
            var generatorSystem = MicrosoftQuantumChemistryJordanWignerJordanWignerGeneratorSystem.Apply(data);
#line 27 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
    ...
    public class Simulate : Operation<(Microsoft.Quantum.Chemistry.JordanWigner.JordanWignerEncodingData,Double,Double), QArray<QArray<Double>>>, ICallable
    {
        ...
        String ICallable.FullName => "ResourceEstimation.Simulate";
        ...
        protected ICallable<(QArray<Microsoft.Quantum.Chemistry.JordanWigner.JordanWignerInputState>,QArray<Qubit>), QVoid> PrepareTrialState
        {
            get;
            set;
        }
...
#line 33 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
            Message.Apply("BEGINNING SIMULATION");
#line 35 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
            var (nSpinOrbitals,fermionTermData,statePrepData,energyOffset) = data.Data;
#line 38 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
            var out_val = new QArray<QArray<Double>>(0L);
#line 42 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
            var (ham_terms,nOrbitals) = create_generator.Apply(data);
#line 44 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
            Message.Apply(String.Format("{0}", nOrbitals));
#line 47 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
            var ground_energy = 1000D;
#line 48 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
            var ground_phase = 3D;
#line 49 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
            var index = 0L;
#line hidden
            {
#line 52 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
                var testQ = Allocate.Apply(nOrbitals);
#line 53 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
                var phi = 0D;
#line 54 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
                while (true)
                {
#line 55 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
                    var temp_out_array = new QArray<QArray<Double>>(1L);
#line 56 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
                    Message.Apply(String.Format("Testing phase: {0}", phi));
#line 58 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
                    Message.Apply(String.Format("{0}", energyOffset));
#line 62 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
                    var initial_oracle = PrepareTrialState.Partial(new Func<QArray<Qubit>, (QArray<Microsoft.Quantum.Chemistry.JordanWigner.JordanWignerInputState>,QArray<Qubit>)>((__arg1__) => (statePrepData?.Copy(), __arg1__)));
#line 66 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
                    var discovered_energy = (SumExpectedValues.Apply((initial_oracle, ham_terms, testQ?.Copy(), moe)) + energyOffset);
#line 69 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
                    temp_out_array[0L] = new QArray<Double>(phi, discovered_energy);
#line 72 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
                    out_val = (out_val + temp_out_array);
#line 75 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
                    if ((discovered_energy < ground_energy))
                    {
#line 78 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
                        ground_energy = discovered_energy;
#line 79 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
                        ground_phase = phi;
                    }

#line 82 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
                    Message.Apply(String.Format("ENERGY FOUND: {0}", discovered_energy));
#line 85 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
                    index = (index + 1L);
#line 88 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
                    phi = (phi + precision);
                    if ((phi >= 20D))
                    {
                        break;
...
#line 94 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
            Message.Apply(String.Format("Ground energy: {0}", ground_energy));
#line 95 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
            Message.Apply(String.Format("Ground state: {0}", ground_phase));
#line 96 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
            return out_val;
        }
        ...
        public override void Init()
        {
            ...
            this.PrepareTrialState = this.Factory.Get<ICallable<(QArray<Microsoft.Quantum.Chemistry.JordanWigner.JordanWignerInputState>,QArray<Qubit>), QVoid>>(typeof(PrepareTrialState));
    ...
    public class prepareStateHelper : Operation<(QArray<Microsoft.Quantum.Canon.ComplexPolar>,QArray<Qubit>), QVoid>, ICallable
    {
        ...
        String ICallable.FullName => "ResourceEstimation.prepareStateHelper";
...
#line 101 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
...
#line hidden
    ...
    public class SumExpectedValues : Operation<(ICallable,Microsoft.Quantum.Canon.GeneratorSystem,QArray<Qubit>,Double), Double>, ICallable
    {
        ...
        String ICallable.FullName => "ResourceEstimation.SumExpectedValues";
...
#line 111 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
            var total = 0D;
#line 117 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
            var (num_of_terms,jw_term_indexer) = HamiltonianGates.Data;
#line 120 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
            foreach (var i in new Range(0L, (num_of_terms - 1L)))
#line hidden
            {
#line 121 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
                Message.Apply(String.Format("Completed term: {0} / {1}. Current total: {2}", (i + 1L), num_of_terms, total));
#line 123 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
                var jw_term = jw_term_indexer.Apply<Microsoft.Quantum.Canon.GeneratorIndex>(i);
#line 126 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
                var gate_basis_pairs = MultiUnitaryCreatePauliSet.Apply((jw_term, ancilla?.Copy()));
#line 129 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
                foreach (var gate_combo in new Range(0L, (gate_basis_pairs.Length - 1L)))
#line hidden
                {
#line 132 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
                    var (gate_to_evaluate,basis,value) = gate_basis_pairs[gate_combo];
#line 135 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
                    var ((gate_keys,weight),targets) = jw_term.Data;
#line 138 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
                    total = (total + (weight[0L] * FindExpectedValue.Apply((initial_oracle, gate_to_evaluate, basis?.Copy(), ancilla?.Copy(), moe))));
                }
            }

#line 141 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
            return total;
        }
    ...
    public class FindExpectedValue : Operation<(ICallable,ICallable,QArray<Pauli>,QArray<Qubit>,Double), Double>, ICallable
    {
        ...
        String ICallable.FullName => "ResourceEstimation.FindExpectedValue";
...
#line 151 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
            var Z_SCORE = 1.96D;
#line 154 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
            var out_val = -(10D);
#line 157 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
            var run_sum = 0D;
#line 160 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
            var total_runs = 0D;
#line 163 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
            var error_term = 1D;
#line 165 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
            while (true)
            {
#line 166 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
                foreach (var i in new Range(0L, 10L))
#line hidden
                {
#line 168 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
                    if (RunSingleIteration.Apply((InitialStateOracle, gate, measure_basis?.Copy(), ancilla?.Copy())))
                    {
#line 170 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
                        run_sum = (run_sum + 1D);
                    }

#line 172 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
                    total_runs = (total_runs + 1D);
                }

#line 176 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
                out_val = (run_sum / total_runs);
#line 179 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
...
#line 187 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
    ...
    public class MarginOfError : Function<(Double,Double,Double), Double>, ICallable
    {
        ...
        String ICallable.FullName => "ResourceEstimation.MarginOfError";
...
#line 193 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
    ...
    public class RunSingleIteration : Operation<(ICallable,ICallable,QArray<Pauli>,QArray<Qubit>), Boolean>, ICallable
    {
        ...
        String ICallable.FullName => "ResourceEstimation.RunSingleIteration";
...
#line 203 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
            InitialStateOracle.Apply(ancilla?.Copy());
#line 206 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
            MysteryGate.Apply(ancilla?.Copy());
#line 210 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
            AssertProb.Apply((basis?.Copy(), ancilla?.Copy(), Result.One, 0D, "Set to 0.0 for Resource Estimation", 1E-05D));
#line 211 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
            var out_val = ((Measure.Apply((basis?.Copy(), ancilla?.Copy())) == Result.One) ? true : false);
#line 216 "/Users/Julian/polybox/490Qproject/VQE/ResourceEstimation/Operations.qs"
            return out_val;
        }
